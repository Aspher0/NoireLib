...
public sealed class SmokeSceneSection : IDisposable
{
    ...
    private void Spawn()
    {
        ...
        var dz = center.Z - 7f;
        s.AddBox(Material.Decal(DecalShape.Circle, new Vector4(0.30f, 0.70f, 1f, 0.9f)) with { Surface = DecalSurface.Ground }, new Vector3(center.X - 9f, center.Y, dz), "Decal.Circle", keepCpuData: true)
