...
/// <summary>
/// Locks the event bus's core contract: subscribers are invoked in priority order, a filter gates delivery per
/// handler, unsubscription (by token, first match, or owner) removes exactly the intended handlers, a handler's
/// exception never stops its siblings, and an inactive bus publishes nothing.
/// </summary>
