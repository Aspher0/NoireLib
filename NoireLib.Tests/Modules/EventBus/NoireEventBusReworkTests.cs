...
/// <summary>
/// Locks EventBus contracts that <see cref="NoireEventBusTests"/> does not exercise: the
/// <see cref="EventExceptionMode"/> policies LogAndThrow and Suppress, a throwing filter routed through the same
/// exception policy as a throwing handler, keyed subscription replacement and key-based unsubscription, and the
/// priority order <see cref="NoireEventBus.UnsubscribeFirst{TEvent}"/> preserves when a keyed subscription is
/// replaced.
/// </summary>
