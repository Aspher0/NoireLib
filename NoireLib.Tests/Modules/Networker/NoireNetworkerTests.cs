...
/// <summary>
/// Integration tests for the NoireNetworker module, running the real stack (kernel mutex election, memory-mapped
/// rendezvous, and loopback TCP) across multiple module instances inside this test process.
/// </summary>
