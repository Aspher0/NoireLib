...
public class NoireOverlayButtonTests
{
    ...
    [Theory]
    [InlineData(false, false, false, false)] // Nothing active -> visible
    [InlineData(true, false, false, true)]   // Cutscene -> hidden
    [InlineData(false, true, false, true)]   // Gpose -> hidden
    [InlineData(false, false, true, true)]   // Game UI hidden -> hidden
