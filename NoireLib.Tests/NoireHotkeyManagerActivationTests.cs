...
/// This decision logic reads live game input in production and so was never covered; these tests pin its behavior
/// by driving it with synthetic "combination active" / "key physically down" inputs and an explicit clock, one
/// tick at a time, for every activation mode. They exist to hold the behavior fixed across the state-machine
/// refactor: any change to the trigger stream a mode produces is a change these tests must be updated to reflect
