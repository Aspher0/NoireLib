...
/// <summary>
/// Locks the event wrapper lifecycle: enabling subscribes exactly once and disabling unsubscribes
/// exactly once, registered callbacks fire on the wrapped event, and disposing clears callbacks and
/// unsubscribes without re-raising them.
/// </summary>
