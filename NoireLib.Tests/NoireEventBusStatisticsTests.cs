...
/// <see cref="EventBusStatistics.TotalEventsPublished"/> counts publishes rather than deliveries.<br/>
/// Publishing to an event type nobody has subscribed to takes the bus's early return, and leaving the counter on the
/// far side of that return made the statistic silently report only the events that happened to reach a handler.
/// </summary>
