...
/// <c>default</c>. If these defaults were expressed as property initializers instead of read-time fallbacks, a marker
/// drawn without a style would silently get <c>FillOpacity = 0</c> and <c>OutlineWidth = 0</c> and paint nothing at
/// all, and a flat curve would get <c>Segments = 0</c> and collapse to a triangle. Both spellings must agree.
/// </summary>
