...
{
    /// <summary>A flat, subdivided grid: (n+1)² unique vertices spanning 10x10 in XZ, two triangles per cell.</summary>
    ...
    {
        // At radius 100 the unbiased selection is level 1; a 2x bias scales the 160/60/22 boundaries to 320/120/44,
        // pushing 100 below the second boundary to level 2.
