...
/// <param name="PlacardInstanceId">The level-file instance id of the plot's placard, or zero when the row names none.</param>
public readonly record struct HousingPlot(int Index, HousingInteriorKind Kind, uint PlacardInstanceId = 0);
