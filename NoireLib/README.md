...
Those modules are all-in-one autonomous packages you can easily add, configure and use extremely easily.<br/>
Each of the modules are made with one goal in mind: provide the easiest way to do a thing, and do it good.<br/>
...
- [NoireDraw3D](https://github.com/Aspher0/NoireLib/blob/main/NoireLib/Draw3D/README.md) - A real D3D11 world renderer: terrain-hugging decals, shapes, meshes, glTF model import, render-to-texture and picking - glowless, hook-free, ImGui-free
