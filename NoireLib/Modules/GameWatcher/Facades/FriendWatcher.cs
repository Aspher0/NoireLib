...
/// The proxy refreshes in the background on a jittered cadence
/// (<see cref="GameWatcherOptions.FriendsRefreshCadence"/>); values are seconds-grained and can lag reality
/// between refreshes.
/// </summary>
