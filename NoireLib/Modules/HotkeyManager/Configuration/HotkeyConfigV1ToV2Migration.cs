...
/// version 2 (a <c>Hotkeys</c> map of id to <see cref="PersistedHotkey"/>).<br/>
/// Each stored binding is lifted into a persisted-hotkey object carrying that exact binding; every other option
/// comes up at its <see cref="PersistedHotkey"/> default. The binding's JSON is moved rather than reserialized, so
/// the migration cannot alter a value it does not understand.
/// </summary>
