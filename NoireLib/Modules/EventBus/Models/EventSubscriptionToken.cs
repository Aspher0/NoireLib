...
/// <summary>A token representing an event subscription, used to unsubscribe from events.</summary>
public readonly struct EventSubscriptionToken : IEquatable<EventSubscriptionToken>
{
    private readonly Guid ID;

    internal EventSubscriptionToken(NoireSubscriptionToken subscription)
    {
        ID = subscription.Id;
        Subscription = subscription;
    }

    // The registry subscription this token stands for; null for a default token.
    internal NoireSubscriptionToken? Subscription { get; }

    /// <summary>Equals method to compare two EventSubscriptionToken instances.</summary>
    ...
    /// <summary>Equals method to compare with an object.</summary>
    ...
    /// <summary>Gets the hash code for this token.</summary>
    /// <returns>The hash code of the token.</returns>
    public override int GetHashCode() => ID.GetHashCode();

    /// <summary>Equality operator to compare two EventSubscriptionToken instances.</summary>
    ...
    /// <summary>Inequality operator to compare two EventSubscriptionToken instances.</summary>
    /// <param name="left">The left <see cref="EventSubscriptionToken"/>.</param>
    /// <param name="right">The right <see cref="EventSubscriptionToken"/>.</param>
    /// <returns>The result of the inequality comparison.</returns>
    public static bool operator !=(EventSubscriptionToken left, EventSubscriptionToken right) => !left.Equals(right);

    /// <summary>ToString override to provide a string representation of the token.</summary>
