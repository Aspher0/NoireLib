...
public sealed class RingStyle
{
    ...
    /// <summary>Where the fill starts, in turns clockwise from twelve o'clock.</summary>
    public float StartTurns { get; set; }

    /// <summary>How much of the circle a full value covers, in turns.</summary>
    public float SweepTurns { get; set; } = 1f;

    /// <summary>Whether the fill runs clockwise.</summary>
    ...
    // In real pixels, at the user's scale.
