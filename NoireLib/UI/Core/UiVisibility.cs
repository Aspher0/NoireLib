...
/// The consequence: once a plugin asks for any of this, hiding is the library's job rather than Dalamud's, so a window
/// that does not ask is hidden by <see cref="NoireUI.ShouldHide"/> instead. A plain Dalamud window that never consults
/// it would simply stay visible. See <see cref="NoireUI.RequiredVisibility"/>.
/// </remarks>
[Flags]
