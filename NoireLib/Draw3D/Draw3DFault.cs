...
/// <summary>
/// A self-disable notification raised through <see cref="NoireDraw3D.OnFault"/> when the narrowest responsible
/// feature was disabled and everything else keeps rendering.
/// </summary>
/// <param name="Kind">The ladder rung the fault landed on.</param>
/// <param name="Message">The description of what was disabled and why.</param>
