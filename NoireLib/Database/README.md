...
- [Defining Database Models](#defining-database-models)
  ...
  - [3. Manual Accessors](#3-manual-accessors)
  - [4. Custom Schema Definitions](#4-custom-schema-definitions)
...
- [Relationships](#relationships)
  ...
  - [3. BelongsToMany](#3-belongstomany)
- [Validation Rules](#validation-rules)
- [Casting](#casting)
- [Using the Database Core](#using-the-database-core)
- [Database Migrations](#database-migrations)
  - [1. Create migrations](#1-create-migrations)
  - [2. Use common operations](#2-use-common-operations)
  - [3. Check current schema version](#3-check-current-schema-version)
